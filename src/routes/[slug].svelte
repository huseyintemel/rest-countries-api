...
<div class="bg-light-gray dark:bg-very-dark-blue font-nunito flex lg:fixed w-full h-full">
    <div class="mx-8 lg:mx-20 w-full">
        <button on:click={goBack} class="my-12 shadow-md px-4 py-1.5 focus:outline-none rounded-md inline-flex items-center bg-white dark:bg-dark-blue dark:text-white dark:border-dark-blue font-semibold">
       ...
       <div class="flex flex-col lg:flex-row space-x-0 lg:space-x-16">
            ...
            <div class="flex flex-col my-10 w-full max-w-xl xl:max-w-3xl flex-shrink-0">
                <h1 class="font-bold text-2xl dark:text-white">{country.name}</h1>
                ...
                <div class="flex flex-col xl:flex-row space-x-0 xl:space-x-4 items-start xl:items-center mt-8">
                    <span class="font-bold mb-4 xl:mb-0 whitespace-nowrap dark:text-white">Border Countries:</span>
                    {#if country.borders}
